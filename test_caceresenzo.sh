...
do
	...
	do
		...
		do
			...
			$COMPILER $compiler_error_limit_flag -std=c++98 -g3 $fsanitize_flag -Wall -Wextra -Werror -I. -I${TEST_DIR}/support -DTEST_USE_STD=$TEST_STD -DNOTIFY_WHICH=$NOTIFY_WHICH $test_file -o $test_bin
			compiled_exit_code=$?
