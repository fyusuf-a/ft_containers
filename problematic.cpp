...
/*   Updated: 2022/04/25 16:44:37 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print(ft::map<K, V> const &map)
{
	typename ft::map<K, V>::const_iterator it;
...
{
	{
		...
		std::cout << "deleting from " << NEXT(m.begin(), 2)->first << std::endl;
